import { type IPropTypes, editorProps } from '@tinymce/tinymce-vue/lib/es2015/main/ts/components/EditorPropTypes';
...
type __TinymceEvents = {
  [K in keyof Events.EditorEventMap as Uncapitalize<K>]: [event: Events.EditorEventMap[K], editor: Editor];
};
